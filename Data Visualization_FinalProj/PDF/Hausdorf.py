...
P=dfP['Hausdorf']
Pl = dfP["Hausdorf"].values

dfN = pd.read_csv(r"C:\Users\ar54482\Desktop\DataCellShapeFinalNS.csv")
N=dfN['Hausdorf']
Nl = dfN["Hausdorf"].values

dfC = pd.read_csv(r"C:\Users\ar54482\Desktop\DataCellShapeFinalC.csv")
C=dfC['Hausdorf']
Cl = dfC["Hausdorf"].values

my_colors=['blue','green','red']

#C=sns.distplot(C,  kde=True, hist=False,bins=int(180/5), color = 'blue', hist_kws=dict(cumulative=True), kde_kws=dict(cumulative=True))
#
#
...
plt.xlabel('Hausdorf (in pixels)',fontsize=14)
