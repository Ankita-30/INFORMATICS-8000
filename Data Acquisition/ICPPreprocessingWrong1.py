...
import os
#specify the path
path=(r"C:\Users\ar54482\Desktop\Data\Main_data\L88-57\C\ControlP_shapes\segmented\wrong\1")
...
# Read the image you want the connected components extracted from
    ...
    #img = cv2.imread(r'C:\Users\ar54482\Desktop\Data\Main_data\L88-57\C\ControlP_shapes\segmented\wrong\1\16.jpg',0)
    ...
    S=math.degrees(math.atan(1.25208203))
    Sr=math.atan(1.25208203)
    print('S',S)
    print('Sr',Sr)
    ...
    if H=="Right":
        ...
        #print(coords_d1[0][1][0])     
            ...
            ax.set_ylim(-350,350)
            ax.set_xlim(-350,350)
            os.chdir(r'C:\Users\ar54482\Desktop\Data\Main_data\L88-57\C\ControlP_shapes\segmented\Pre-alignedC')
            plt.savefig(filename)
            os.chdir(r'C:\Users\ar54482\Desktop\Data\Main_data\L88-57\C\ControlP_shapes\segmented\wrong\1')
