...
import os
#specify the path
path=(r"C:\Users\ar54482\Desktop\Data\Main_data\L88-57\PS\Stress_shapes\segmented\All filled shapes")
...
# Read the image you want the connected components extracted from
    ...
    if H=="Right":
        ...
        #print(coords_d1[0][1][0])     
            ...
            ax.set_ylim(-350,350)
            ax.set_xlim(-350,350)
            os.chdir(r'C:\Users\ar54482\Desktop\Data\Main_data\L88-57\PS\Stress_shapes\segmented\Pre-alignedPS')
            plt.savefig(filename)
            os.chdir(r"C:\Users\ar54482\Desktop\Data\Main_data\L88-57\PS\Stress_shapes\segmented\All filled shapes")
