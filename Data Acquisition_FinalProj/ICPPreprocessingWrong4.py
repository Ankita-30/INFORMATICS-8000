# -*- coding: utf-8 -*-
"""
Created on Wed Jan 29 13:31:18 2020
...
img = cv2.imread(r'C:\Users\ar54482\Desktop\Data\Main_data\L88-57\NS\Allfilledshapes123\New\220.jpg',0)
...
if H=="Left":
    ...
    if abs(Ir4)<Sr:
        ...
        ax.set_xlim(-350,350)
        os.chdir(r'C:\Users\ar54482\Desktop\Data\Main_data\L88-57\NS\Pre-aligned_NS')
        plt.savefig(r'C:\Users\ar54482\Desktop\Data\Main_data\L88-57\NS\Pre-aligned_NS\220.jpg')
